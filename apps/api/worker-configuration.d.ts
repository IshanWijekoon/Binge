/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d4a84b5cb5f04ed2d1da9fca1331eb4a)
// Runtime types generated with workerd@1.20260701.1 2026-07-02 nodejs_compat
interface __BaseEnv_Env {
	CACHE: KVNamespace;
	DB: D1Database;
	APP_ENV: "production";
	ALLOWED_ORIGINS: "https://binge.ishanmadusanka.dev,https://binge-web.pages.dev,http://localhost:3000,http://127.0.0.1:3000";
	ADMIN_SESSION_COOKIE_NAME: "binge_admin_session";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "ALLOWED_ORIGINS" | "ADMIN_SESSION_COOKIE_NAME" | "ADMIN_SESSION_TTL_SECONDS" | "TVMAZE_BASE_URL" | "ADMIN_PASSWORD_HASH">> {}
}
